    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route('super-admin.tenants.index') }}" class="nav-link" data-key="t-analytics">
                        Tenant </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('super-admin.owners.index') }}" class="nav-link" data-key="t-analytics">
                        Owner </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('subscription.index') }}" class="nav-link" data-key="t-analytics">
                        Subscription </a>
                </li>
