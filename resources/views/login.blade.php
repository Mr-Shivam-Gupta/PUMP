...
<body>
    <section class="hero">
        <div class="hero-content">
            <img src="https://cdn-icons-png.flaticon.com/512/9154/9154309.png" class="logo">
            ...
            <ul class="nav nav-tabs mb-4" id="loginTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#superadmin">Super Admin</button></li>
                <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#owner">Owner</button></li>
                <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tenant">Tenant</button></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="superadmin">
                    <form method="POST" action="/super-admin/login">
                        @csrf
                        <input type="email" class="form-control mb-3" name="email" placeholder="Super Admin Email" required>
                ...
                <div class="tab-pane fade" id="owner">
                    <form method="POST" action="/owner/login">
                        @csrf
                        <input type="email" class="form-control mb-3" name="email" placeholder="Owner Email" required>
                        <input type="password" class="form-control mb-3" name="password" placeholder="Password" required>
                ...
                <div class="tab-pane fade" id="tenant">
                    <form method="POST" action="/tenant/login">
                        @csrf
                        <input type="email" class="form-control mb-3" name="email" placeholder="Tenant Email" required>
                        <input type="password" class="form-control mb-3" name="password" placeholder="Password" required>
                ...
                <div class="tab-pane fade" id="employee">
                    <form method="POST" action="/employee/login">
                        @csrf
                        <input type="text" class="form-control mb-3" name="employee_id" placeholder="Employee ID" required>
                        <input type="password" class="form-control mb-3" name="password" placeholder="Password" required>
        ...
        <div class="hero-illustration">
            <img src="https://cdn-icons-png.flaticon.com/512/3589/3589058.png">
        </div>
